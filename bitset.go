...
// SetBit ensures that the given bit is set in the BitSet.
...
// ClearBit ensures that the given bit is cleared (not set) in the BitSet.
...
// IsBitSet returns true if the given bit is set, false if it is cleared.
