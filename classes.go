...
func GetClassInfo() (array [19]string){

	array[0] = "-Untold wonders and secrets exist for those skillful enough to discover them. Through cleverness, talent, and magic, " +
				"these cunning few unravel the wiles of the world, becoming adept in the arts of persuasion, manipulation, and inspiration. "

	array[1] = "-In faith and the miracles of the divine, many find a greater purpose. Called to serve powers beyond most mortal understanding, " +
	...
	array[2] = "-Within the purity of the elements and the order of the wilds lingers a power beyond the marvels of civilization." +
	...
	array[4] = "-A devoted enchanter shines most brightly in more subtle settings, either in infiltration, " +
	...
	array[5] = "-Some take up arms for glory, wealth, or revenge. Others do battle to prove themselves, to protect others, or because they know nothing else. " +
	...
	array[6] = "-For the truly exemplary, martial skill transcends the battlefield—it is a lifestyle, a doctrine, a state of mind. " +
	...
	array[7] = "-While others use magic to do paltry things like conjure fire or fly, the Necromancer is a master over death itself. " +
				...
				"Each enemy they fell becomes an eager and disposable ally, they become immune to the energies of death and decay, and ultimately harness the immortality and power of undeath for themselves."

	array[8] = "-A ninja is one who refines stealth, intellegence gathering, powerful combat techniques, and mysticism into a " +
	...
	array[9] = "-Through a select, worthy few shines the power of the divine. Called paladins, " +
	...
	array[10] = "-Rumors abound about the oddly dressed human man on the corner. He stands there calling to those who are sick, " +
	...
	array[11] = "-Planeswalkers are the source of an infinite energy, called the Planeswalker's Spark. " +
	...
	array[12] = "-For those who relish the thrill of the hunt, there are only predators and prey. Be they scouts, trackers, or bounty hunters, " +
	...
	array[13] = "Life is an endless adventure for those who live by their wits. Ever just one step ahead of danger, rogues bank on their cunning, " +
	...
	array[14] = "-While travelling through swamps, forests and deserts a young human receives directions from the spirits. " +
	...
	array[15] = "-Similar to the monk, they are masters of unarmed combat. However, they are less restricted in combat, " +
	...
	array[16] = "-Throughout the ages and across civilizations, there has and will always arise the inevitable desire, " +
	...
	array[17] = "-Scions of innately magical bloodlines, the chosen of deities, the spawn of monsters, pawns of fate and destiny, " +
	...
	array[18] = "-Beyond the veil of the mundane hide the secrets of absolute power. The works of beings beyond mortals, " +
